...
/**
 * This class defines the structure of the 'tw_subscription_list_invitation' table.
 *
 *
 ...
 */
class twSubscriptionListInvitationTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'plugins.twSubscriptionPlugin.lib.model.map.twSubscriptionListInvitationTableMap';
    ...
    {
        // attributes
        $this->setName('tw_subscription_list_invitation');
        $this->setPhpName('twSubscriptionListInvitation');
        $this->setClassname('twSubscriptionListInvitation');
...
} // twSubscriptionListInvitationTableMap
