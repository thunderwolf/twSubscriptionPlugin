...
<div id="sf_admin_container">
  <h1><?php echo __('Edit TwSubscriptionEmail', array(), 'messages') ?></h1>

  <?php include_partial('twSubscriptionEmail/flashes') ?>

  <div id="sf_admin_header">
    <?php include_partial('twSubscriptionEmail/form_header', array('tw_subscription_email' => $tw_subscription_email, 'form' => $form, 'configuration' => $configuration)) ?>
  </div>

  <div id="sf_admin_content">
    <?php include_partial('twSubscriptionEmail/form', array('tw_subscription_email' => $tw_subscription_email, 'form' => $form, 'configuration' => $configuration, 'helper' => $helper)) ?>
  </div>

  <div id="sf_admin_footer">
    <?php include_partial('twSubscriptionEmail/form_footer', array('tw_subscription_email' => $tw_subscription_email, 'form' => $form, 'configuration' => $configuration)) ?>
  </div>
</div>
