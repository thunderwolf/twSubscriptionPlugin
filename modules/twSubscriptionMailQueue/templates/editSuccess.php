...
<div id="sf_admin_container">
  <h1><?php echo __('Edit TwSubscriptionMailQueue', array(), 'messages') ?></h1>

  <?php include_partial('twSubscriptionMailQueue/flashes') ?>

  <div id="sf_admin_header">
    <?php include_partial('twSubscriptionMailQueue/form_header', array('tw_subscription_mail_queue' => $tw_subscription_mail_queue, 'form' => $form, 'configuration' => $configuration)) ?>
  </div>

  <div id="sf_admin_content">
    <?php include_partial('twSubscriptionMailQueue/form', array('tw_subscription_mail_queue' => $tw_subscription_mail_queue, 'form' => $form, 'configuration' => $configuration, 'helper' => $helper)) ?>
  </div>

  <div id="sf_admin_footer">
    <?php include_partial('twSubscriptionMailQueue/form_footer', array('tw_subscription_mail_queue' => $tw_subscription_mail_queue, 'form' => $form, 'configuration' => $configuration)) ?>
  </div>
</div>
