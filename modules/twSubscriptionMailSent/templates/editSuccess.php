...
<div id="sf_admin_container">
  <h1><?php echo __('Edit TwSubscriptionMailSent', array(), 'messages') ?></h1>

  <?php include_partial('twSubscriptionMailSent/flashes') ?>

  <div id="sf_admin_header">
    <?php include_partial('twSubscriptionMailSent/form_header', array('tw_subscription_mail_sent' => $tw_subscription_mail_sent, 'form' => $form, 'configuration' => $configuration)) ?>
  </div>

  <div id="sf_admin_content">
    <?php include_partial('twSubscriptionMailSent/form', array('tw_subscription_mail_sent' => $tw_subscription_mail_sent, 'form' => $form, 'configuration' => $configuration, 'helper' => $helper)) ?>
  </div>

  <div id="sf_admin_footer">
    <?php include_partial('twSubscriptionMailSent/form_footer', array('tw_subscription_mail_sent' => $tw_subscription_mail_sent, 'form' => $form, 'configuration' => $configuration)) ?>
  </div>
</div>
