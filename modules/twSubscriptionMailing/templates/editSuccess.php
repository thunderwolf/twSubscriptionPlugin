...
<div id="sf_admin_container">
  <h1><?php echo __('Create or edit your mailer
', array(), 'messages') ?></h1>

  <?php include_partial('twSubscriptionMailing/flashes') ?>

  <div id="sf_admin_header">
    <?php include_partial('twSubscriptionMailing/form_header', array('tw_subscription_mailing' => $tw_subscription_mailing, 'form' => $form, 'configuration' => $configuration)) ?>
  </div>

  <div id="sf_admin_content">
    <?php include_partial('twSubscriptionMailing/form', array('tw_subscription_mailing' => $tw_subscription_mailing, 'form' => $form, 'configuration' => $configuration, 'helper' => $helper)) ?>
  </div>

  <div id="sf_admin_footer">
    <?php include_partial('twSubscriptionMailing/form_footer', array('tw_subscription_mailing' => $tw_subscription_mailing, 'form' => $form, 'configuration' => $configuration)) ?>
  </div>
</div>
