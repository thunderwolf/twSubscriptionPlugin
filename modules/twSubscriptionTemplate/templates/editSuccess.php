...
<div id="sf_admin_container">
  <h1><?php echo __('Edit TwSubscriptionTemplate', array(), 'messages') ?></h1>

  <?php include_partial('twSubscriptionTemplate/flashes') ?>

  <div id="sf_admin_header">
    <?php include_partial('twSubscriptionTemplate/form_header', array('tw_subscription_template' => $tw_subscription_template, 'form' => $form, 'configuration' => $configuration)) ?>
  </div>

  <div id="sf_admin_content">
    <?php include_partial('twSubscriptionTemplate/form', array('tw_subscription_template' => $tw_subscription_template, 'form' => $form, 'configuration' => $configuration, 'helper' => $helper)) ?>
  </div>

  <div id="sf_admin_footer">
    <?php include_partial('twSubscriptionTemplate/form_footer', array('tw_subscription_template' => $tw_subscription_template, 'form' => $form, 'configuration' => $configuration)) ?>
  </div>
</div>
