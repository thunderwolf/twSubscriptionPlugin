...
<div id="sf_admin_container">
  <h1><?php echo __('Edit TwSubscriptionMessage', array(), 'messages') ?></h1>

  <?php include_partial('twSubscriptionMessage/flashes') ?>

  <div id="sf_admin_header">
    <?php include_partial('twSubscriptionMessage/form_header', array('tw_subscription_message' => $tw_subscription_message, 'form' => $form, 'configuration' => $configuration)) ?>
  </div>

  <div id="sf_admin_content">
    <?php include_partial('twSubscriptionMessage/form', array('tw_subscription_message' => $tw_subscription_message, 'form' => $form, 'configuration' => $configuration, 'helper' => $helper)) ?>
  </div>

  <div id="sf_admin_footer">
    <?php include_partial('twSubscriptionMessage/form_footer', array('tw_subscription_message' => $tw_subscription_message, 'form' => $form, 'configuration' => $configuration)) ?>
  </div>
</div>
