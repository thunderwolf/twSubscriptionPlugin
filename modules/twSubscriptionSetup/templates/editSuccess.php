...
<div id="sf_admin_container">
  <h1><?php echo __('Edit TwSubscriptionSetup', array(), 'messages') ?></h1>

  <?php include_partial('twSubscriptionSetup/flashes') ?>

  <div id="sf_admin_header">
    <?php include_partial('twSubscriptionSetup/form_header', array('tw_subscription_setup' => $tw_subscription_setup, 'form' => $form, 'configuration' => $configuration)) ?>
  </div>

  <div id="sf_admin_content">
    <?php include_partial('twSubscriptionSetup/form', array('tw_subscription_setup' => $tw_subscription_setup, 'form' => $form, 'configuration' => $configuration, 'helper' => $helper)) ?>
  </div>

  <div id="sf_admin_footer">
    <?php include_partial('twSubscriptionSetup/form_footer', array('tw_subscription_setup' => $tw_subscription_setup, 'form' => $form, 'configuration' => $configuration)) ?>
  </div>
</div>
