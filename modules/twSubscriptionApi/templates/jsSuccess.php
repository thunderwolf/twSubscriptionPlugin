...
<div class="sub_row"><label for="sub_z<?php echo $form_id; ?>z_email">Twój e-mail:</label> <input tyle="text" id="sub_z<?php echo $form_id; ?>z_email" class="sub_email" /></div>\
<div class="sub_row"><label for="sub_z<?php echo $form_id; ?>z_name">Twoje imię:</label> <input type="text" id="sub_z<?php echo $form_id; ?>z_name" class="sub_name" /></div>\
